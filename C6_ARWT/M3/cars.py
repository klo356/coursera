...
def process_data(data):
  ...
  for item in data:
    ...
    # Track the car with the most sales
    ...
    if car_year not in max_sales_by_year:
      max_sales_by_year[car_year] = item["total_sales"]
    else:
      max_sales_by_year[car_year] += item["total_sales"]
  # Find the year with the maximum sales
  max_year = max(max_sales_by_year, key=max_sales_by_year.get)
  ...
  summary = [
    ...
    "The most popular year was {} with {} sales.".format(max_year, max_sales_by_year[max_year])
  ]
  return summary
...
def cars_dict_to_table(car_data):
  ...
  # Sort car_data by total_sales in descending order
